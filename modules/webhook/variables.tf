...
variable "dynamodb_update_role_arn" {
  type        = string
  description = "The ARN of the IAM role to use when updating the DynamoDB table given in dynamodb_table_name. This role must have at least full put-item access to the table contents."
}
